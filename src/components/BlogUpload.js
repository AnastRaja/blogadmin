...
function App() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage('Failed to create blog: ' + (error.response?.data?.message || 'Unknown error'));
    }
  };
  ...
  return (
    <div className="App">
      ...
      <form onSubmit={handleSubmit} className="max-w-lg mx-auto p-4 bg-white shadow-md rounded">
        ...
        <div className="mb-4">
          <label htmlFor="body" className="block text-gray-700 font-semibold mb-2">Blog Body</label>
          <Editor
        ...
        <div className="mb-4">
          <label htmlFor="image" className="block text-gray-700 font-semibold mb-2">Blog Image</label>
          <input
            type="file"
            id="image"
            accept="image/*"
